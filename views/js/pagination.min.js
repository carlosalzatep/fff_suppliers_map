            ...
            l = {
                ...
                generateHTML: function (a) {
                    ...
                    return D && (c = d.replaceVariables(D, {
                        ...
                        totalPage: f,
                        totalNumber: g
                    }), v += c), (h || j || i) && (v += '<div class="paginationjs-pages">', v += u ? '<ul class="' + u + '">' : "<ul>", h && (e <= 1 ? B || (v += '<li class="' + s + "-prev " + t + '"><a>< <span> Précédent</span></a></li>') : v += '<li class="' + s + '-prev J-paginationjs-previous" data-num="' + (e - 1) + '" title="Previous page"><a href="' + o + '">< <span> Précédent</span></a></li>'), j && (v += d.generatePageNumbersHTML(a)), i && (e >= f ? C || (v += '<li class="' + s + "-next " + t + '"><a> <span>Suivant </span> ></a></li>') : v += '<li class="' + s + '-next J-paginationjs-next" data-num="' + (e + 1) + '" title="Suivant"><a href="' + o + '" > <span>Suivant </span> ></a></li>'), v += "</ul></div>"), l && y && (c = d.replaceVariables(y, {
                        currentPage: e,
                        totalPage: f,
                        totalNumber: g
